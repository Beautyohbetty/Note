...
import com.example.android.notepad.util.Note;
import com.example.android.notepad.util.DateUtil;
import java.util.ArrayList;
import java.util.List;
import com.example.android.notepad.util.MyApplication;
...
public class NotesListAdapter extends BaseAdapter {
    ...
    private List<Note> mDate;
    private List<Note> searchData;//被搜所到数据
 ...
 */
    ...
    public List<Note> getmDate() {
        return mDate;
    }

    public void setmDate(List<Note> mDate) {
        this.mDate = mDate;
    }
